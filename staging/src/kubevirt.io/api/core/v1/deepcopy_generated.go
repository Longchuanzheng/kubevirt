...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClockOffsetLocalTime) DeepCopyInto(out *ClockOffsetLocalTime) {
	*out = *in
	if in.DisableMigrate != nil {
		in, out := &in.DisableMigrate, &out.DisableMigrate
		*out = new(bool)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClockOffsetLocalTime.
func (in *ClockOffsetLocalTime) DeepCopy() *ClockOffsetLocalTime {
	if in == nil {
		return nil
	}
	out := new(ClockOffsetLocalTime)
